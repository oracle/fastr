...
CALLDEF(api_RAW_ELT, 2),
CALLDEF(api_LOGICAL_ELT, 2),
CALLDEF(api_INTEGER_ELT, 2),
CALLDEF(api_REAL_ELT, 2),
CALLDEF(api_INTEGER_IS_SORTED, 1),
CALLDEF(api_INTEGER_NO_NA, 1),
CALLDEF(api_REAL_IS_SORTED, 1),
CALLDEF(api_REAL_NO_NA, 1),
CALLDEF(api_LOGICAL_IS_SORTED, 1),
CALLDEF(api_LOGICAL_NO_NA, 1),
CALLDEF(api_STRING_IS_SORTED, 1),
CALLDEF(api_STRING_NO_NA, 1),
...
CALLDEF(api_norm_rand, 0),
CALLDEF(api_exp_rand, 0),
CALLDEF(api_Rf_classgets, 2),
CALLDEF(api_EXTPTR_PTR, 1),
...
CALLDEF(api_SET_PRCODE, 2),
CALLDEF(api_SET_PRENV, 2),
CALLDEF(api_SET_PRVALUE, 2),
...
CALLDEF(api_R_removeVarFromFrame, 2),
