...
# FastR commented-out: roller.lsfu <- lsfit(roller$depression, roller$weight)
...
# FastR commented-out: all.equal(unname(im.lm0 $ infmat),
# FastR commented-out:           unname(cbind(  dfbetas      (roller.lm0)
# FastR commented-out:                        , dffits       (roller.lm0)
# FastR commented-out:                        , covratio     (roller.lm0)
# FastR commented-out:                        ,cooks.distance(roller.lm0)
# FastR commented-out:                        ,lm.influence  (roller.lm0)$hat)
# FastR commented-out:                  ))
...
all.equal(rstudent(roller.lm),
          rstudent(roller.glm))
# FastR commented-out: all.equal(cooks.distance(roller.lm),
# FastR commented-out:           cooks.distance(roller.glm))
