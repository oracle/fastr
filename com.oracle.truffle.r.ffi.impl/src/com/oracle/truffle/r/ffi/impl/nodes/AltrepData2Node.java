...
/**
 * Node for getting the second instance data of an ALTREP vector.
 */
@GenerateUncached
...
public abstract class AltrepData2Node extends FFIUpCallNode.Arg1 {
    ...
    protected Object getData2FromAltrepCached(@SuppressWarnings("unused") RAbstractAtomicVector altrepVec,
    ...
    protected Object getData2FromAltrepUncached(RAbstractAtomicVector altrepVec) {
