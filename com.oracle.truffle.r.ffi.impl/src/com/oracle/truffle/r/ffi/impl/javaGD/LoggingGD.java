...
public class LoggingGD extends GDInterface {
    ...
    private void intro() {
        ...
        writer.printf("closeLog <- function() grDevices:::gdClose()\n");
        writer.printf("replayLogWithAWT <- function() replayLog('awt', FALSE)\n");
        writer.printf("replayLog <- function(deviceName = '%s', close = TRUE, pageNumber=%d) {\n", deviceName, pageNumber);
