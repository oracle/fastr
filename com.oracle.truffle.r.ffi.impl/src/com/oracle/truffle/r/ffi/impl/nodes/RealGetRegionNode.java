...
@GenerateUncached
public abstract class RealGetRegionNode extends GetRegionNode {
    public static RealGetRegionNode create() {
        return RealGetRegionNodeGen.create();
    }
    ...
    public long doBufferArray(RDoubleVector doubleVec, long fromIdx, long size, Object buffer,
        ...
        return dataLibrary.getDoubleRegion(doubleVec.getData(), (int) fromIdx, (int) size, buffer, bufferInterop);
    }
    ...
    public long doGenericBuffer(RIntVector vec, long fromIdx, long size, Object buffer,
        ...
        return dataLibrary.getDoubleRegion(vec.getData(), (int) fromIdx, (int) size, bufferWrapper, bufferWrapperInterop);
    }
}
