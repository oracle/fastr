...
public abstract class AbstractContainerLibrary extends Library {
     ...
     * @param deep We do not really need this argument in FastR - it is only forwarded to
     *             the corresponding ALTREP methods in order to be compatible with GNU-R.
     *             In GNU-R this argument is used only for some internal GC procedures, with
     *             no visible effects.
     */
