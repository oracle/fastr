...
public final class RError extends RuntimeException {
    ...
    public static enum Message {
        ...
        INVALID_LENGTH("invalid 'length' argument"),
        ...
        INVALID_TIMES("invalid 'times' argument"),
        ...
        INVALID_BYROW("invalid 'byrow' argument"),
        ...
        INVALID_MODE("invalid 'mode' argument"),
        ...
        ARGUMENT_NOT_ARRAY("argument %s is not a array"),
