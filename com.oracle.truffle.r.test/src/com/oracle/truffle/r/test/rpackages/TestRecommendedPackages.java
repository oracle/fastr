...
public class TestRecommendedPackages extends TestRPackages {
    private static final String[] OK_PACKAGES = new String[]{"MASS", "boot", "class", "codetools", "lattice", "nnet", "spatial", "survival"};
    @SuppressWarnings("unused") private static final String[] PROBLEM_PACKAGES = new String[]{"cluster", "KernSmooth", "Matrix", "foreign", "nlme", "rpart"};
