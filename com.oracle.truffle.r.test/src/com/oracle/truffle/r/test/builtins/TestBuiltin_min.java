...
public class TestBuiltin_min extends TestBase {
    ...
    public void testmin5() {
        assertEval("argv <- list(structure(list(c(1L, 2L, 4L), 1:3, c(2L, 1L)), class = c('package_version', 'numeric_version')));min(argv[[1]][[1]],argv[[1]][[2]], na.rm = FALSE);");
    }
    ...
    public void testmin8() {
        assertEval("argv <- list(structure(c(3L, 2L, 1L), .Label = c('A', 'B', 'C'), class = c('ordered', 'factor')));min(argv[[1]][[1]],argv[[1]][[2]], na.rm = FALSE);");
    }
    ...
    public void testmin14() {
        assertEval("argv <- list(structure(c(13823, NA), class = 'Date'));min(argv[[1]][[1]],argv[[1]][[2]], na.rm = TRUE);");
    }

    @Test
    public void testmin15() {
        assertEval("argv <- list(structure(c(1208822400, 1209168000), class = c('POSIXct', 'POSIXt'), tzone = 'GMT'));min(argv[[1]][[1]],argv[[1]][[2]], na.rm = FALSE);");
    }
