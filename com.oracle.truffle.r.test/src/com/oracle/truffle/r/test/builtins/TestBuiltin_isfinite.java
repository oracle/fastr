...
public class TestBuiltin_isfinite extends TestBase {
    ...
    public void testisfinite6() {
        // FIXME FastR ignores .Dimnames in structure()
        assertEval(Ignored.OutputFormatting, "argv <- list(structure(1.27861470300044, .Dim = c(1L, 1L), .Dimnames = list('(Intercept)', '(Intercept)')));is.finite(argv[[1]]);");
    }
    ...
    public void testisfinite9() {
        // FIXME FastR ignores .Names in structure()
