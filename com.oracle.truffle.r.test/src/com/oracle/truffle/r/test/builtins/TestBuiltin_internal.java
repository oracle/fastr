...
public class TestBuiltin_internal extends TestBase {
    ...
    public void testIndirectInternalInvocation() {
        ...
        // .Internal(paste0) and .Internal(paste) behave differently in GNU-R (version 4.0.3) during loading of base package - they expect
        // different number of arguments. We ignore error message for now because we handle calls to .Internal(paste) the same
