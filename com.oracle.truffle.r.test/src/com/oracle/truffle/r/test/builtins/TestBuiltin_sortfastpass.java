...
public class TestBuiltin_sortfastpass extends TestBase {
    ...
    public void testsortfastpass() {
        ...
        assertEval("argv <- list(1:10, FALSE, FALSE); argv2 <- argv + 1; .Internal(sorted_fpass(argv2[[1]], argv2[[2]], argv2[[3]]))");
        assertEval("argv <- list(c(1,2,3,4,5,6,7,8), FALSE, FALSE); argv2 <- argv + 1; .Internal(sorted_fpass(argv2[[1]], argv2[[2]], argv2[[3]]))");
    }
}
