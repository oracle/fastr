...
public class TestrGenBuiltinformatPOSIXlt extends TestBase {
    ...
    public void testformatPOSIXlt2() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 10.7712235450745, min = 48L, hour = 14L, mday = 17L, mon = 2L, year = 114L, wday = 1L, yday = 75L, isdst = 1L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'), tzone = c(\'\', \'EST\', \'EDT\')), \'%Y-%m-%d\', FALSE); .Internal(format.POSIXlt(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void testformatPOSIXlt3() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 59.7693939208984, min = 47L, hour = 18L, mday = 17L, mon = 2L, year = 114L, wday = 1L, yday = 75L, isdst = 0L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'), tzone = \'GMT\'), \'%Y-%m-%d %H:%M:%S\', TRUE); .Internal(format.POSIXlt(argv[[1]], argv[[2]], argv[[3]]))");
    }
    ...
    public void testformatPOSIXlt5() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 0, min = 0L, hour = 19L, mday = 31L, mon = 11L, year = 69L, wday = 3L, yday = 364L, isdst = 0L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'), tzone = c(\'\', \'EST\', \'EDT\')), \'%Y-%m-%d %H:%M:%S\', TRUE); .Internal(format.POSIXlt(argv[[1]], argv[[2]], argv[[3]]))");
    }
    ...
    public void testformatPOSIXlt8() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 11.3034093379974, min = 37L, hour = 7L, mday = 7L, mon = 11L, year = 113L, wday = 6L, yday = 340L, isdst = 0L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'), tzone = c(\'\', \'EST\', \'EDT\')), \'%H:%M:%OS3\', FALSE); .Internal(format.POSIXlt(argv[[1]], argv[[2]], argv[[3]]))");
    }
