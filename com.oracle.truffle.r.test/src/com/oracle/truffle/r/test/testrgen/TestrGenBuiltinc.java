...
public class TestrGenBuiltinc extends TestBase {
    ...
    @Test
    public void testc9() {
        assertEval(Ignored.Unknown, "argv <- list(NULL, structure(list(class = \'try-error\', condition = structure(list(message = \'more columns than column names\', call = quote(read.table(\'foo6\', header = TRUE))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\'))), .Names = c(\'class\', \'condition\')));c(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testc10() {
        assertEval(Ignored.Unknown, "argv <- list(NULL, structure(list(class = \'try-error\', condition = structure(list(message = \'supply both 'x' and 'y' or a matrix-like 'x'\', call = quote(cor(rnorm(10), NULL))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\'))), .Names = c(\'class\', \'condition\')));c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc15() {
        assertEval(Ignored.Unknown, "argv <- list(NULL, structure(list(class = \'try-error\', condition = structure(list(message = \'(converted from warning) NAs produced\', call = quote(rexp(2, numeric()))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\'))), .Names = c(\'class\', \'condition\')));c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc18() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(V1 = c(1L, 1L, 2L, 3L), V2 = structure(c(1L, 1L, 2L, 3L), .Label = c(\'A\', \'D\', \'E\'), class = \'factor\'), V3 = c(6, 6, 9, 10)), .Names = c(\'V1\', \'V2\', \'V3\'), row.names = c(NA, 4L), class = \'data.frame\'), sep = \'\\r\');c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc20() {
        assertEval(Ignored.Unknown, "argv <- list(NULL, structure(list(class = \'try-error\', condition = structure(list(message = \'non-numeric argument to mathematical function\', call = quote(log(\'a\'))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\'))), .Names = c(\'class\', \'condition\')));c(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testc21() {
        assertEval(Ignored.Unknown, "argv <- list(NULL, structure(list(class = \'try-error\', condition = structure(list(message = \''x' is empty\', call = quote(cor(Z[, FALSE], use = \'pairwise.complete.obs\', method = \'kendall\'))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\'))), .Names = c(\'class\', \'condition\')));c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc24() {
        assertEval(Ignored.Unknown, "argv <- list(NULL, structure(list(class = \'try-error\', condition = structure(list(message = \'undefined columns selected\', call = quote(`[.data.frame`(dd, , \'C\'))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\'))), .Names = c(\'class\', \'condition\')));c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc28() {
        assertEval(Ignored.Unknown, "argv <- list(NULL, structure(list(class = \'try-error\', condition = structure(list(message = \'(converted from warning) NAs produced\', call = quote(rnorm(1, sd = Inf))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\'))), .Names = c(\'class\', \'condition\')));c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc41() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(1:3), class = c(\'package_version\', \'numeric_version\')), structure(list(c(2L, 1L)), class = c(\'package_version\', \'numeric_version\')));c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc43() {
        assertEval(Ignored.Unknown, "argv <- list(list(structure(list(u = c(5, 10, 15, 20, 30, 40, 60, 80, 100), lot1 = c(118, 58, 42, 35, 27, 25, 21, 19, 18), lot2 = c(69, 35, 26, 21, 18, 16, 13, 12, 12)), .Names = c(\'u\', \'lot1\', \'lot2\'), row.names = c(NA, -9L), class = \'data.frame\')), structure(list(max.level = 0, give.attr = FALSE, digits = 3), .Names = c(\'max.level\', \'give.attr\', \'digits\')));c(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testc44() {
        assertEval(Ignored.Unknown, "argv <- list(list(structure(list(structure(\'vpl1\', class = c(\'vpListing\', \'gridVectorListing\', \'gridListing\')), structure(\'1\', class = c(\'vpUpListing\', \'gridVectorListing\', \'gridListing\'))), class = c(\'gridListListing\', \'gridListing\'))), list(structure(\'vpl2\', class = c(\'vpListing\', \'gridVectorListing\', \'gridListing\'))));c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc56() {
        assertEval(Ignored.Unknown, "argv <- list(369.430769230769, 4.99999999999983);c(argv[[1]],argv[[2]]);");
    }
    ...
    @Test
    public void testc67() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(0.06, 0.32, 0.63), .Names = c(\'0%\', \'25%\', \'50%\')), 909.591818181818, structure(c(0.905, 10000), .Names = c(\'75%\', \'100%\')));c(argv[[1]],argv[[2]],argv[[3]]);");
    }
    ...
    @Test
    public void testc70() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(Topic = character(0), File = character(0)), .Names = c(\'Topic\', \'File\'), class = \'data.frame\', row.names = integer(0)), sep = \'\\r\');c(argv[[1]],argv[[2]]);");
    }
