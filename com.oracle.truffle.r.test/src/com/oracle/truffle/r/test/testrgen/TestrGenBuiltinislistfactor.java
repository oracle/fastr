...
public class TestrGenBuiltinislistfactor extends TestBase {
    ...
    public void testislistfactor2() {
        assertEval(Ignored.Unknown, "argv <- list(list(c(TRUE, FALSE, FALSE, FALSE, FALSE), c(TRUE, TRUE, TRUE, TRUE, NA)), FALSE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testislistfactor3() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(a = 6:10), .Names = \'a\', row.names = 6:10), FALSE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testislistfactor4() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(k = 0.413311097189709, g1 = 72.8306629700373, g2 = 181.793153976139), .Names = c(\'k\', \'g1\', \'g2\')), TRUE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testislistfactor5() {
        assertEval(Ignored.Unknown, "argv <- list(list(structure(list(structure(\'text\', Rd_tag = \'VERB\')), Rd_tag = \'\\\\alias\'), structure(list(structure(\'text.default\', Rd_tag = \'VERB\')), Rd_tag = \'\\\\alias\')), TRUE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }
    ...
    public void testislistfactor7() {
        assertEval(Ignored.Unknown, "argv <- list(list(c(\'     The binary arithmetic operators are generic functions: methods can\', \'     be written for them individually or via the ‘Ops’ group generic\', \'     function.  (See ‘Ops’ for how dispatch is computed.)\')), TRUE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testislistfactor8() {
        assertEval(Ignored.Unknown, "argv <- list(list(structure(list(structure(1:4, .Label = c(\'0\', \'1\', \'2\', \'3\'), class = \'factor\')), row.names = c(NA, -4L), class = \'data.frame\')), FALSE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testislistfactor9() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(`1` = c(2, 1, 4, 3), `2` = c(3, 1.5, 5, 4, 1.5), `3` = c(6.5, 1.5, 9, 8, 1.5, 6.5, 4, 4, 4), `4` = c(7, 1.5, 10, 9, 1.5, 7, 4, 4, 4, 7)), .Dim = 4L, .Dimnames = list(c(\'1\', \'2\', \'3\', \'4\'))), TRUE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }
    ...
    public void testislistfactor11() {
        assertEval(Ignored.Unknown, "argv <- list(list(structure(0, .Dim = c(1L, 1L)), structure(-4.9497224423095e-07, .Dim = c(1L, 1L)), structure(0, .Dim = c(1L, 1L)), structure(-7.44931694456399e-07, .Dim = c(1L, 1L))), FALSE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }
    ...
    public void testislistfactor13() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(`1` = 1.97626258336499e-323), .Names = \'1\'), FALSE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }
    ...
    public void testislistfactor15() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(`1` = 8.91763605923317e+38), .Names = \'1\'), FALSE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }
    ...
    public void testislistfactor18() {
        assertEval(Ignored.Unknown, "argv <- list(list(structure(list(structure(\'rm\', Rd_tag = \'VERB\')), Rd_tag = \'\\\\alias\'), structure(list(structure(\'remove\', Rd_tag = \'VERB\')), Rd_tag = \'\\\\alias\')), TRUE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }
    ...
    public void testislistfactor21() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(), .Names = character(0)), TRUE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testislistfactor22() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(a = \'a\', b = 2, c = 3.14159265358979+2i), .Names = c(\'a\', \'b\', \'c\')), TRUE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }
    ...
    public void testislistfactor27() {
        assertEval(Ignored.Unknown, "argv <- list(structure(\'mtext(\\\'«Latin-1 accented chars»: éè øØ å<Å æ<Æ\\\', side = 3)\\n\', Rd_tag = \'RCODE\'), TRUE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testislistfactor28() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(V1 = structure(c(\'head\', \'1\', \'3\', \'6\'), class = \'AsIs\'), V2 = structure(c(\'NA\', \' 2\', \' 4\', \' 7\'), class = \'AsIs\'), V3 = structure(c(\'NA\', \'NA\', \' 5\', \' 8\'), class = \'AsIs\'), V4 = structure(c(\'NA\', \'NA\', \'NA\', \' 9\'), class = \'AsIs\')), .Names = c(\'V1\', \'V2\', \'V3\', \'V4\'), row.names = c(\'1\', \'2\', \'3\', \'4\')), FALSE); .Internal(islistfactor(argv[[1]], argv[[2]]))");
    }
