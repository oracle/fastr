...
public class TestrGenBuiltinnamesassign extends TestBase {

    @Test
    public void testnamesassign1() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(happy = c(\'a\', \'b\', \'c\', \'d\'), sad = c(\'A\', \'B\', \'C\', \'D\', \'E\', \'F\')), .Names = c(\'happy\', \'sad\')), value = c(\'happy\', \'sad\'));`names<-`(argv[[1]],argv[[2]]);");
    }
    ...
    public void testnamesassign5() {
        assertEval(Ignored.Unknown, "argv <- list(c(-3.21402130636699, 101.08748330158, -8.50234284659562), value = NULL);`names<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testnamesassign6() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1:3, .Names = c(NA, \'b\', NA)), value = c(NA, \'b\'));`names<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testnamesassign7() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(3.14159265358979e-10, 0.0314159265358979, 3.14159265358979, 31.4159265358979, 314.159265358979, 314159265.358979, 3.14159265358979e+20), .Names = c(\'3.14e-10\', \'0.0314\', \'3.14\', \'31.4\', \'314\', \'3.14e+08\', \'3.14e+20\')), value = c(\'3.14e-10\', \'0.0314\', \'3.14\', \'31.4\', \'314\', \'3.14e+08\', \'3.14e+20\'));`names<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testnamesassign8() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(\'variable1\', \'variable2\'), .Names = c(\'variable1\', \'variable2\')), value = c(\'variable1\', \'variable2\'));`names<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testnamesassign9() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(NA, FALSE, TRUE), .Names = c(NA, \'FALSE\', \'TRUE\')), value = c(NA, \'FALSE\', \'TRUE\'));`names<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testnamesassign10() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(), .Names = character(0)), character(0));`names<-`(argv[[1]],argv[[2]]);");
    }
    ...
    public void testnamesassign12() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(100, -1e-13, Inf, -Inf, NaN, 3.14159265358979, NA), .Names = c(\' 100\', \'-1e-13\', \' Inf\', \'-Inf\', \' NaN\', \'3.14\', \'  NA\')), value = c(\' 100\', \'-1e-13\', \' Inf\', \'-Inf\', \' NaN\', \'3.14\', \'  NA\'));`names<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testnamesassign13() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(A = 0:10, B = 10:20, `NA` = 20:30), .Names = c(\'A\', \'B\', NA), row.names = c(NA, -11L), class = \'data.frame\'), value = c(\'A\', \'B\', NA));`names<-`(argv[[1]],argv[[2]]);");
    }
    ...
    public void testnamesassign16() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1:3, .Names = c(\'foo\', \'bar\', \'baz\')), value = c(\'foo\', \'bar\', \'baz\'));`names<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testnamesassign17() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1+1i, 1.2+10i), .Names = c(\'a\', \'b\')), value = c(\'a\', \'b\'));`names<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testnamesassign18() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(67L, 34L), .Dim = 2L, .Dimnames = list(c(\'\\\'actual\\\'\', \'virtual\')), class = \'table\'), value = c(\'\\\'actual\\\'\', \'virtual\'));`names<-`(argv[[1]],argv[[2]]);");
    }
}
