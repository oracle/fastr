...
public class TestrGenBuiltinlevelsassign extends TestBase {

    @Test
    public void testlevelsassign1() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1:2, .Label = c(\'a\', \'b\'), class = \'factor\'), value = structure(list(C = \'C\', A = \'a\', B = \'b\'), .Names = c(\'C\', \'A\', \'B\')));`levels<-`(argv[[1]],argv[[2]]);");
    }
    ...
    public void testlevelsassign4() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1L, 1L, 2L, 2L, 3L, 3L, 1L, 1L, 2L, 2L, 3L, 3L), .Label = c(\'1\', \'2\', \'3\'), class = \'factor\'), value = structure(list(A = c(1, 3), B = 2), .Names = c(\'A\', \'B\')));`levels<-`(argv[[1]],argv[[2]]);");
    }
