...
public class TestrGenBuiltinunclass extends TestBase {
    ...
    public void testunclass4() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(X1.10 = 1:10, z = structure(list(x = 1:10, yyy = 11:20), .Names = c(\'x\', \'yyy\'), row.names = c(NA, -10L), class = \'data.frame\')), .Names = c(\'X1.10\', \'z\'), row.names = c(NA, -10L)));unclass(argv[[1]]);");
    }
    ...
    public void testunclass19() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(b = structure(c(3L, 1L, 2L), .Label = c(\'A\', \'B\', \'C\'), class = \'factor\'), a = structure(c(1386423981.90268, 1386403981.90268, 1386413981.90268), class = c(\'POSIXct\', \'POSIXt\'))), .Names = c(\'b\', \'a\'), row.names = c(3L, 1L, 2L)));unclass(argv[[1]]);");
    }
    ...
    public void testunclass21() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(325, 285, 706, 885), .Dim = c(1L, 4L), row.vars = structure(list(), .Names = character(0)), col.vars = structure(list(Class = c(\'1st\', \'2nd\', \'3rd\', \'Crew\')), .Names = \'Class\')));unclass(argv[[1]]);");
    }
    ...
    public void testunclass25() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(srcfile = \'/home/lzhao/tmp/RtmpYl9n1I/R.INSTALL2aa24b6697e5/MASS/R/negbin.R\', frow = 135L, lrow = 137L), .Names = c(\'srcfile\', \'frow\', \'lrow\'), row.names = c(NA, -1L)));unclass(argv[[1]]);");
    }
    ...
    public void testunclass29() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(surname = structure(\'R Core\', class = \'AsIs\'), nationality = structure(NA_integer_, .Label = c(\'Australia\', \'UK\', \'US\'), class = \'factor\'), deceased = structure(NA_integer_, .Label = c(\'no\', \'yes\'), class = \'factor\')), .Names = c(\'surname\', \'nationality\', \'deceased\'), row.names = 7L));unclass(argv[[1]]);");
    }
    ...
    public void testunclass35() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(group = structure(c(1L, 1L), .Label = c(\'Ctl\', \'Trt\'), class = \'factor\')), .Names = \'group\', row.names = 1:2, terms = quote(~group)));unclass(argv[[1]]);");
    }

    @Test
    public void testunclass36() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(2671, 6.026e+77, 3.161e+152, 3.501e+299, 2.409e+227, 1.529e+302), .Names = c(\'Min.\', \'1st Qu.\', \'Median\', \'Mean\', \'3rd Qu.\', \'Max.\')));unclass(argv[[1]]);");
    }
}
