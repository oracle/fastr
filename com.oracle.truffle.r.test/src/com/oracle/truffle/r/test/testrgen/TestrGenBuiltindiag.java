...
public class TestrGenBuiltindiag extends TestBase {
    ...
    public void testdiag5() {
        assertEval(Ignored.Unknown, "argv <- list(c(-2.80063713410797-0i, 2.40432724210166-0i, -1.40502612938985+0i, 1.39344241164891+0i, 0.785422253492721+0i), 5L, 5L); .Internal(diag(argv[[1]], argv[[2]], argv[[3]]))");
    }
    ...
    public void testdiag8() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(0.553622032575332, 1.83583330034692, 0.540309168173204, 0.347171956892285), .Names = c(\'A\', \'B\', \'C\', \'D\')), 4L, 4L); .Internal(diag(argv[[1]], argv[[2]], argv[[3]]))");
    }
