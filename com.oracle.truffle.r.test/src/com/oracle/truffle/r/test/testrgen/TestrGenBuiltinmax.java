...
public class TestrGenBuiltinmax extends TestBase {
    ...
    public void testmax2() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1208822400, 1209168000, 1208822400, 1209168000), class = c(\'POSIXct\', \'POSIXt\')), na.rm = TRUE);max(argv[[1]],argv[[2]]);");
    }
    ...
    public void testmax5() {
        assertEval(Ignored.Unknown, "max( );");
    }
    ...
    public void testmax11() {
        assertEval(Ignored.Unknown, "argv <- list(numeric(0));max(argv[[1]]);");
    }
    ...
    public void testmax17() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(3L, 2L, 1L), .Label = c(\'A\', \'B\', \'C\'), class = c(\'ordered\', \'factor\')), na.rm = FALSE);max(argv[[1]],argv[[2]]);");
    }
    ...
    public void testmax20() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1208822400, 1209168000), class = c(\'POSIXct\', \'POSIXt\'), tzone = \'GMT\'), na.rm = FALSE);max(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testmax21() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(13823, NA), class = \'Date\'), na.rm = TRUE);max(argv[[1]],argv[[2]]);");
    }
