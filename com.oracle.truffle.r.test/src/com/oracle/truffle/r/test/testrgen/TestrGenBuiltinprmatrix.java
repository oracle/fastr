...
public class TestrGenBuiltinprmatrix extends TestBase {
    ...
    public void testprmatrix2() {
        assertEval(Ignored.Unknown, "argv <- list(structure(FALSE, .Dim = c(1L, 1L)), NULL, NULL, TRUE, FALSE, NULL); .Internal(prmatrix(argv[[1]], argv[[2]], argv[[3]], argv[[4]], argv[[5]], argv[[6]]))");
    }
    ...
    public void testprmatrix4() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(952L, 3622L, 202L, 406L), .Dim = c(2L, 2L), .Dimnames = list(c(\'subcohort\', \'cohort\'), c(\'1\', \'2\'))), c(\'subcohort\', \'cohort\'), c(\'1\', \'2\'), FALSE, FALSE, NULL); .Internal(prmatrix(argv[[1]], argv[[2]], argv[[3]], argv[[4]], argv[[5]], argv[[6]]))");
    }
