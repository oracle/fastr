...
public class TestrGenBuiltinatanh extends TestBase {
    ...
    public void testatanh3() {
        assertEval(Ignored.Unknown, "argv <- list(-0.133190890463189);atanh(argv[[1]]);");
    }

    @Test
    public void testatanh4() {
        assertEval(Ignored.Unknown, "argv <- list(c(2+0i, 2-0.0001i, -2+0i, -2+0.0001i));atanh(argv[[1]]);");
    }
}
