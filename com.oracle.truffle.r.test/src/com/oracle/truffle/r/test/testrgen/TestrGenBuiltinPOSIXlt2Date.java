...
public class TestrGenBuiltinPOSIXlt2Date extends TestBase {
    ...
    public void testPOSIXlt2Date2() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = c(0, NA), min = c(0L, NA), hour = c(0L, NA), mday = c(6L, NA), mon = c(10L, NA), year = c(107L, NA), wday = c(2L, NA), yday = c(309L, NA), isdst = c(0L, -1L)), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'))); .Internal(POSIXlt2Date(argv[[1]]))");
    }

    @Test
    public void testPOSIXlt2Date3() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = numeric(0), min = integer(0), hour = integer(0), mday = integer(0), mon = integer(0), year = integer(0), wday = integer(0), yday = integer(0), isdst = integer(0)), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'))); .Internal(POSIXlt2Date(argv[[1]]))");
    }

    @Test
    public void testPOSIXlt2Date4() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 0, min = 0L, hour = 0L, mday = 1L, mon = 0L, year = 79L, wday = 1L, yday = 0L, isdst = 0L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'))); .Internal(POSIXlt2Date(argv[[1]]))");
    }
    ...
    public void testPOSIXlt2Date6() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 0, min = 0L, hour = 0L, mday = 1L, mon = c(0, 3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36), year = 100L, wday = 6L, yday = 0L, isdst = 0L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'), tzone = \'UTC\')); .Internal(POSIXlt2Date(argv[[1]]))");
    }
    ...
    public void testPOSIXlt2Date8() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 0, min = 0L, hour = 0L, mday = 1L, mon = 0L, year = 109L, wday = 4L, yday = 0L, isdst = 0L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'))); .Internal(POSIXlt2Date(argv[[1]]))");
    }
    ...
    public void testPOSIXlt2Date10() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 33.1798663139343, min = 47L, hour = 14L, mday = 17L, mon = 2L, year = 114L, wday = 1L, yday = 75L, isdst = 1L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'), tzone = c(\'\', \'EST\', \'EDT\'))); .Internal(POSIXlt2Date(argv[[1]]))");
    }
}
