...
public class TestrGenBuiltinattrassign extends TestBase {

    @Test
    public void testattrassign1() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1, foo = structure(list(a = \'a\'), .Names = \'a\')), \'foo\', value = structure(list(a = \'a\'), .Names = \'a\'));`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }

    @Test
    public void testattrassign2() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(-99, 123, 0, -27, 0, 136, 3.5527136788005e-14, 0, -89, -59, 54.9999999999999, -260, 30, 47, 0), .Dim = c(5L, 3L)), \'dimnames\', value = NULL);`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }

    @Test
    public void testattrassign3() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1, 0, 0, 0, NA, 1, 0, 0, 0, 7, 1, 0, 3, 0, 0, 1), .Dim = c(4L, 4L)), \'dimnames\', value = NULL);`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }
    ...
    public void testattrassign5() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA), .Dim = 3:4), \'dimnames\', value = NULL);`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }

    @Test
    public void testattrassign6() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(\'o\', \'p\', \'v\', \'i\', \'r\', \'w\', \'b\', \'m\', \'f\', \'s\'), date = structure(1224086400, class = c(\'POSIXct\', \'POSIXt\'), tzone = \'\')), \'date\', value = structure(1224086400, class = c(\'POSIXct\', \'POSIXt\'), tzone = \'\'));`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }
    ...
    public void testattrassign8() {
        assertEval(Ignored.Unknown, "argv <- list(structure(4, \'`Object created`\' = \'Sat Dec  7 00:26:20 2013\'), \'Object created\', value = \'Sat Dec  7 00:26:20 2013\');`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }

    @Test
    public void testattrassign9() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1:3, .Names = c(\'a\', \'b\', \'c\')), \'names\', value = list(\'a\', \'b\', \'c\'));`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }

    @Test
    public void testattrassign10() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(a = 1:3, b = structure(1:3, .Label = c(\'a\', \'b\', \'c\'), class = \'factor\')), .Names = c(\'a\', \'b\'), row.names = c(NA, -3L), class = \'data.frame\', foo = 10), \'foo\', value = 10);`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }
    ...
    public void testattrassign12() {
        assertEval(Ignored.Unknown, "argv <- list(structure(numeric(0), .Dim = c(0L, 20L)), \'dimnames\', value = NULL);`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }
    ...
    public void testattrassign14() {
        assertEval(Ignored.Unknown, "argv <- list(structure(logical(0), .Dim = c(0L, 20L)), \'dimnames\', value = NULL);`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }
    ...
    public void testattrassign16() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(0, -187, -34, 0, 165, 0, -95, 121, 107, 0, 41, 0, 0, 93, 0), .Dim = c(5L, 3L)), \'dimnames\', value = NULL);`attr<-`(argv[[1]],argv[[2]],argv[[3]]);");
    }
}
