...
public class TestrGenBuiltinlog10 extends TestBase {
    ...
    public void testlog104() {
        assertEval(Ignored.Unknown, "argv <- list(c(0.0654707112145738, 0.999999999999999));log10(argv[[1]]);");
    }
    ...
    public void testlog107() {
        assertEval(Ignored.Unknown, "argv <- list(structure(numeric(0), .Dim = c(20L, 0L), .Dimnames = list(c(\'ant\', \'bee\', \'cat\', \'cpl\', \'chi\', \'cow\', \'duc\', \'eag\', \'ele\', \'fly\', \'fro\', \'her\', \'lio\', \'liz\', \'lob\', \'man\', \'rab\', \'sal\', \'spi\', \'wha\'), NULL)));log10(argv[[1]]);");
    }
}
