...
public class TestrGenBuiltinsubstr extends TestBase {
    ...
    public void testsubstr3() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(\'as.formula\', \'coef\', \'makepredictcall\', \'na.fail\', \'predict\'), .Names = c(\'as.formula\', \'coef\', \'makepredictcall\', \'na.fail\', \'predict\')), 1L, 6L); .Internal(substr(argv[[1]], argv[[2]], argv[[3]]))");
    }
