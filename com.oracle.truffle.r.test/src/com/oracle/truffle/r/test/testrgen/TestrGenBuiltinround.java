...
// Checkstyle: stop line length check
                                                                 ...
                                                                 public class TestrGenBuiltinround extends TestBase {

	@Test
	public void testround1() {
		assertEval("argv <- list(3.98778192287757, 3);"+
			"do.call(\'round\', argv)");
	}
	...
	public void testround2() {
		assertEval("argv <- structure(list(c(37.9490090935718, 34.1981894015095),     digits = 3), .Names = c(\'\', \'digits\'));"+
			"do.call(\'round\', argv)");
	}
