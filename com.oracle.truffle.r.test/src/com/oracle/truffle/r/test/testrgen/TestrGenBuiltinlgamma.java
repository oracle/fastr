...
public class TestrGenBuiltinlgamma extends TestBase {
    ...
    public void testlgamma2() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(2, 3, 2, 1, 4, 4, 7, 2, 11, 11, 15, 10, 7, 8, 13, 12), .Dim = c(4L, 4L), .Dimnames = structure(list(income = c(\'< 15k\', \'15-25k\', \'25-40k\', \'> 40k\'), satisfaction = c(\'VeryD\', \'LittleD\', \'ModerateS\', \'VeryS\')), .Names = c(\'income\', \'satisfaction\'))));lgamma(argv[[1]]);");
    }
    ...
    public void testlgamma9() {
        assertEval(Ignored.Unknown, "argv <- list(Inf);" + "do.call(\'lgamma\', argv)");
    }
