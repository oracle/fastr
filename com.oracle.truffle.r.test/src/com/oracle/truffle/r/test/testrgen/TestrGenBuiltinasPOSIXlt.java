...
public class TestrGenBuiltinasPOSIXlt extends TestBase {

    @Test
    public void testasPOSIXlt1() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(2147483648.4, 2147483648.8), class = c(\'POSIXct\', \'POSIXt\'), tzone = \'\'), \'\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasPOSIXlt2() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(FALSE, FALSE), class = c(\'POSIXct\', \'POSIXt\')), \'\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasPOSIXlt3() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1041324768, class = c(\'POSIXct\', \'POSIXt\'), tzone = \'GMT\'), \'GMT\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasPOSIXlt4() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1208865600, 1208952000, 1209038400, 1209124800, 1209211200), tzone = \'GMT\', class = c(\'POSIXct\', \'POSIXt\')), \'GMT\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasPOSIXlt5() {
        assertEval(Ignored.Unknown, "argv <- list(structure(numeric(0), .Dim = c(0L, 0L)), \'\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasPOSIXlt6() {
        assertEval(Ignored.Unknown, "argv <- list(structure(32569542120, class = c(\'POSIXct\', \'POSIXt\')), \'\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasPOSIXlt7() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1012798800, 1013403600, 1014008400, 1014613200), class = c(\'POSIXct\', \'POSIXt\'), tzone = \'\'), \'\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }
    ...
    public void testasPOSIXlt9() {
        assertEval(Ignored.Unknown, "argv <- list(list(), \'\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasPOSIXlt10() {
        assertEval(Ignored.Unknown, "argv <- list(character(0), \'\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasPOSIXlt11() {
        assertEval(Ignored.Unknown, "argv <- list(NULL, \'\'); .Internal(as.POSIXlt(argv[[1]], argv[[2]]))");
    }
}
