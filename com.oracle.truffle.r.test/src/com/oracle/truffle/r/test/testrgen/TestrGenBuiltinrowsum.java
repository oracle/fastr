...
public class TestrGenBuiltinrowsum extends TestBase {

    @Test
    public void testrowsum1() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1:12, .Dim = 3:4), c(\'Y\', \'X\', \'Y\'), c(\'X\', \'Y\'), FALSE, c(\'X\', \'Y\')); .Internal(rowsum_matrix(argv[[1]], argv[[2]], argv[[3]], argv[[4]], argv[[5]]))");
    }
    ...
    public void testrowsum4() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(0.432389384893196, 2.31273022636069, 0, 2.31273022636069, 0.432389384893196, 0), .Names = c(\'1\', \'3\', \'4\', \'5\', \'6\', \'7\')), structure(c(9, 1, 1, 6, 6, 8), .Names = c(\'1\', \'3\', \'4\', \'5\', \'6\', \'7\')), c(1, 6, 8, 9), FALSE, c(\'1\', \'6\', \'8\', \'9\')); .Internal(rowsum_matrix(argv[[1]], argv[[2]], argv[[3]], argv[[4]], argv[[5]]))");
    }
