...
public class TestrGenBuiltindrop extends TestBase {
    ...
    public void testdrop3() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(-0.146170181357627, 24.3243243243243, NA, 84.2105263157895, 2.13784643479304), .Dim = c(5L, 1L))); .Internal(drop(argv[[1]]))");
    }
    ...
    public void testdrop8() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(c0 = structure(integer(0), .Label = character(0), class = \'factor\')), .Names = \'c0\', row.names = character(0), class = structure(\'integer(0)\', .Names = \'c0\'))); .Internal(drop(argv[[1]]))");
    }
    ...
    public void testdrop10() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(-2.12168716972669e-05, 7.51519194600216e-05, -6.21732236176711e-06), .Dim = c(3L, 1L))); .Internal(drop(argv[[1]]))");
    }

    @Test
    public void testdrop11() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(\' 16\', \' 16\', \'144\', \' 16\', \' 16\', \'128\', \' 16\', \' 16\', \'112\', \' 16\'), .Dim = 10L, .Dimnames = structure(list(c(\'1\', \'6\', \'7\', \'8\', \'13\', \'14\', \'15\', \'20\', \'21\', \'22\')), .Names = \'\'))); .Internal(drop(argv[[1]]))");
    }

	@Test
	public void testdrop13() {
		assertEval("argv <- structure(list(x = structure(c(8, 4, 2), .Dim = c(3L,     1L))), .Names = \'x\');"+
			"do.call(\'drop\', argv)");
	}
