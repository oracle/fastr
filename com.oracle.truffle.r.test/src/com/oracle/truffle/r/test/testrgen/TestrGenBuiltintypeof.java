...
public class TestrGenBuiltintypeof extends TestBase {
	...
	public void testtypeof33() {
		assertEval("argv <- structure(list(x = c(1.1 + (0+0i), NA, 3 + (0+0i))),     .Names = \'x\');"+
			"do.call(\'typeof\', argv)");
	}
	...
	public void testtypeof34() {
		assertEval("argv <- structure(list(x = c(NA_integer_, NA_integer_, NA_integer_)),     .Names = \'x\');"+
			"do.call(\'typeof\', argv)");
	}
