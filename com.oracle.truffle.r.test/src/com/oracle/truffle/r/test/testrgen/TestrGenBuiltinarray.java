...
public class TestrGenBuiltinarray extends TestBase {
    ...
    public void testarray5() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(`1` = structure(list(lower = 13.2743449189798, est. = 24.8054653131966, upper = 46.3534067526313), .Names = c(\'lower\', \'est.\', \'upper\'), row.names = \'reStruct.Rail.sd((Intercept))\', class = \'data.frame\')), .Names = \'1\'), c(1L, 1L), list(\'1\', NULL)); .Internal(array(argv[[1]], argv[[2]], argv[[3]]))");
    }
    ...
    public void testarray11() {
        assertEval(Ignored.Unknown, "argv <- list(list(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), 8L, list(c(\'1\', \'2\', \'3\', \'4\', \'5\', \'6\', \'7\', \'8\'))); .Internal(array(argv[[1]], argv[[2]], argv[[3]]))");
    }
    ...
    public void testarray19() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(31.9166666666667, -5.77777777777778, -10.4101831674686, -2.63888888888889, NA), .Names = c(\'(Intercept)\', \'woolB\', \'tens.L\', \'tensionM\', \'tensionH\')), c(5L, 1L), list(c(\'(Intercept)\', \'woolB\', \'tens.L\', \'tensionM\', \'tensionH\'), NULL)); .Internal(array(argv[[1]], argv[[2]], argv[[3]]))");
    }
