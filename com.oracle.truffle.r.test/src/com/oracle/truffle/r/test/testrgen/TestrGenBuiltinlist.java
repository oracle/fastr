...
public class TestrGenBuiltinlist extends TestBase {
    ...
    public void testlist7() {
        assertEval(Ignored.Unknown, "argv <- list(class = \'try-error\', condition = structure(list(message = \'(converted from warning) NAs produced\', call = quote(rnorm(1, sd = Inf))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\')));list(argv[[1]],argv[[2]]);");
    }
    ...
    public void testlist10() {
        assertEval(Ignored.Unknown, "argv <- list(linkfun = function (mu) .Call(C_logit_link, mu), linkinv = function (eta) .Call(C_logit_linkinv, eta), mu.eta = function (eta) .Call(C_logit_mu_eta, eta), valideta = function (eta) TRUE, name = \'logit\');list(argv[[1]],argv[[2]],argv[[3]],argv[[4]],argv[[5]]);");
    }

    @Test
    public void testlist11() {
        assertEval(Ignored.Unknown, "argv <- list(linkfun = function (mu) log(mu), linkinv = function (eta) pmax(exp(eta), .Machine$double.eps), mu.eta = function (eta) pmax(exp(eta), .Machine$double.eps), valideta = function (eta) TRUE, name = \'log\');list(argv[[1]],argv[[2]],argv[[3]],argv[[4]],argv[[5]]);");
    }

    @Test
    public void testlist12() {
        assertEval(Ignored.Unknown, "argv <- list(class = \'try-error\', condition = structure(list(message = \'(converted from warning) NAs produced\', call = quote(rnorm(2, numeric()))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\')));list(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testlist13() {
        assertEval(Ignored.Unknown, "argv <- list(class = \'try-error\', condition = structure(list(message = \'undefined columns selected\', call = quote(`[.data.frame`(dd, , \'x\'))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\')));list(argv[[1]],argv[[2]]);");
    }
    ...
    public void testlist15() {
        assertEval(Ignored.Unknown, "argv <- list(error = function (e) warning(gettextf(\'%s namespace cannot be unloaded:\\n  \', sQuote(pkgname)), conditionMessage(e), call. = FALSE, domain = NA));list(argv[[1]]);");
    }

    @Test
    public void testlist16() {
        assertEval(Ignored.Unknown, "argv <- list(aa = structure(c(\'1\', \'2\', \'3\'), class = \'AsIs\'), ..dfd.row.names = structure(c(\'4\', \'5\', \'6\', \'7\', \'8\', \'9\'), .Dim = c(3L, 2L), .Dimnames = list(NULL, c(\'a\', \'b\'))));list(argv[[1]],argv[[2]]);");
    }
    ...
    public void testlist18() {
        assertEval(Ignored.Unknown, "argv <- list(date = structure(1065672000, class = c(\'POSIXct\', \'POSIXt\'), tzone = \'\'));list(argv[[1]]);");
    }
    ...
    public void testlist20() {
        assertEval(Ignored.Unknown, "argv <- list(\'Residuals vs Fitted\', \'Normal Q-Q\', \'Scale-Location\', \'Cook's distance\', \'Residuals vs Leverage\', expression(\'Cook's dist vs Leverage  \' * h[ii]/(1 - h[ii])));list(argv[[1]],argv[[2]],argv[[3]],argv[[4]],argv[[5]],argv[[6]]);");
    }
    ...
    public void testlist24() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1:5, .Tsp = c(-1, 3, 1), class = \'ts\'), structure(1:5, .Tsp = c(1, 5, 1), class = \'ts\'));list(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testlist25() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(x = 1L, y = structure(1L, .Label = c(\'A\', \'D\', \'E\'), class = \'factor\'), z = 6), .Names = c(\'x\', \'y\', \'z\'), row.names = 1L, class = \'data.frame\'), structure(list(), .Names = character(0), row.names = 1L, class = \'data.frame\'));list(argv[[1]],argv[[2]]);");
    }
    ...
    public void testlist35() {
        assertEval(Ignored.Unknown, "argv <- list(class = \'try-error\', condition = structure(list(message = \'more columns than column names\', call = quote(read.table(\'foo6\', header = TRUE))), .Names = c(\'message\', \'call\'), class = c(\'simpleError\', \'error\', \'condition\')));list(argv[[1]],argv[[2]]);");
    }
    ...
    public void testlist41() {
        assertEval(Ignored.Unknown, "argv <- list(properties = structure(list(.Data = \'numeric\', comment = \'character\'), .Names = c(\'.Data\', \'comment\')), prototype = structure(3.14159265358979, comment = \'Start with pi\'));list(argv[[1]],argv[[2]]);");
    }
    ...
    public void testlist52() {
        assertEval(Ignored.Unknown, "argv <- list(structure(1386392034.50546, class = c(\'POSIXct\', \'POSIXt\')));list(argv[[1]]);");
    }

    @Test
    public void testlist53() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(sec = 54.5054557323456, min = 53L, hour = 23L, mday = 6L, mon = 11L, year = 113L, wday = 5L, yday = 339L, isdst = 0L), .Names = c(\'sec\', \'min\', \'hour\', \'mday\', \'mon\', \'year\', \'wday\', \'yday\', \'isdst\'), class = c(\'POSIXlt\', \'POSIXt\'), tzone = c(\'\', \'EST\', \'EDT\')));list(argv[[1]]);");
    }
    ...
    public void testlist58() {
        assertEval(Ignored.Unknown, "argv <- list(structure(FALSE, .Names = \'Series 1\', .Tsp = c(0, 0, 1), class = \'ts\'), structure(FALSE, .Names = \'Series 1\', .Tsp = c(1, 1, 1), class = \'ts\'));list(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testlist59() {
        assertEval(Ignored.Unknown, "argv <- list(structure(FALSE, .Tsp = c(1, 1, 1), class = \'ts\'), structure(FALSE, .Tsp = c(1, 1, 1), class = \'ts\'));list(argv[[1]],argv[[2]]);");
    }
    ...
    public void testlist61() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE), .Dim = c(12L, 1L), .Dimnames = structure(list(`  p L s` = c(\'. . .\', \'| . .\', \'. | .\', \'| | .\', \'. . |\', \'| . |\', \'. | |\', \'| | |\', \'. . ?\', \'| . ?\', \'. | ?\', \'| | ?\'), NULL), .Names = c(\'  p L s\', \'\'))));list(argv[[1]]);");
    }
    ...
    public void testlist64() {
        assertEval(Ignored.Unknown, "argv <- list(fit = structure(numeric(0), .Dim = c(10L, 0L), constant = 0), se.fit = structure(numeric(0), .Dim = c(10L, 0L)), df = 10L, residual.scale = 0.523484262069588);list(argv[[1]],argv[[2]],argv[[3]],argv[[4]]);");
    }
