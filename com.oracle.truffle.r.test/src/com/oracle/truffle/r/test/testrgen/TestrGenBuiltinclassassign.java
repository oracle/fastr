...
public class TestrGenBuiltinclassassign extends TestBase {
    ...
    public void testclassassign5() {
        assertEval(Ignored.Unknown, "argv <- list(structure(character(0), .Names = character(0), package = character(0), class = structure(\'signature\', package = \'methods\')), value = structure(\'signature\', package = \'methods\'));`class<-`(argv[[1]],argv[[2]]);");
    }
    ...
    public void testclassassign9() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1, 0, 0, 0, 1, 0, 0, 0, 1), .Dim = c(3L, 3L), class = structure(\'mmat2\', package = \'.GlobalEnv\')), value = structure(\'mmat2\', package = \'.GlobalEnv\'));`class<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testclassassign10() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(\'o\', \'p\', \'v\', \'i\', \'r\', \'w\', \'b\', \'m\', \'f\', \'s\'), date = structure(1224086400, class = c(\'POSIXct\', \'POSIXt\'), tzone = \'\'), class = \'stamped\'), value = \'stamped\');`class<-`(argv[[1]],argv[[2]]);");
    }

    @Test
    public void testclassassign11() {
        assertEval(Ignored.Unknown, "argv <- list(structure(3.14159265358979, class = structure(\'3.14159265358979\', class = \'testit\')), structure(3.14159265358979, class = structure(\'3.14159265358979\', class = \'testit\')));`class<-`(argv[[1]],argv[[2]]);");
    }
