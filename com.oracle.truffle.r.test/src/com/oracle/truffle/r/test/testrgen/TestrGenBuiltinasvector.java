...
public class TestrGenBuiltinasvector extends TestBase {
    ...
    public void testasvector12() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(0.164593338447767, 0.182090654313858, NA, 0.484947927602608), .Names = c(\'(Intercept)\', \'x1\', \'x2\', \'x3\')), \'any\'); .Internal(as.vector(argv[[1]], argv[[2]]))");
    }
    ...
    public void testasvector40() {
        assertEval(Ignored.Unknown, "argv <- list(c(NA, NaN), \'logical\'); .Internal(as.vector(argv[[1]], argv[[2]]))");
    }

    @Test
    public void testasvector41() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(`character(0)` = structure(integer(0), .Label = character(0), class = \'factor\')), .Names = \'character(0)\', row.names = character(0), class = \'data.frame\'), \'pairlist\'); .Internal(as.vector(argv[[1]], argv[[2]]))");
    }
    ...
    public void testasvector56() {
        assertEval(Ignored.Unknown, "argv <- list(quote(list(expand.grid(Hair = lab$Hair, Eye = lab$Eye, Sex = lab$Sex, stringsAsFactors = TRUE), Fr = as.vector(HairEyeColor))), \'list\'); .Internal(as.vector(argv[[1]], argv[[2]]))");
    }
    ...
    public void testasvector59() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(`character(0)` = structure(integer(0), .Label = character(0), class = \'factor\')), .Names = \'character(0)\', row.names = character(0), class = \'data.frame\'), \'character\'); .Internal(as.vector(argv[[1]], argv[[2]]))");
    }
    ...
    public void testasvector64() {
        assertEval(Ignored.Unknown, "argv <- list(structure(list(c0 = structure(integer(0), .Label = character(0), class = \'factor\')), .Names = \'c0\', row.names = character(0), class = structure(\'integer(0)\', .Names = \'c0\')), \'any\'); .Internal(as.vector(argv[[1]], argv[[2]]))");
    }
    ...
    public void testasvector71() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(2.2250738585072e-308, 1.79769313486232e+308), .Names = c(\'double.xmin\', \'double.xmax\')), \'any\'); .Internal(as.vector(argv[[1]], argv[[2]]))");
    }
