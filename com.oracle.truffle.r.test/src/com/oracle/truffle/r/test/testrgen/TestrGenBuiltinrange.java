...
public class TestrGenBuiltinrange extends TestBase {
    ...
    public void testrange7() {
        assertEval(Ignored.Unknown, "argv <- list(c(8.2, 9.7, 12.25, 16.5, 21.5, 14.5, 20, 23.45, 25.8, 27.3, 22.4, 24.5, 25.95, 27.3, 30.9), numeric(0), NULL, na.rm = FALSE);range(argv[[1]],argv[[2]],argv[[3]],argv[[4]]);");
    }

    @Test
    public void testrange8() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(3L, 2L, 1L), .Label = c(\'A\', \'B\', \'C\'), class = c(\'ordered\', \'factor\')), na.rm = FALSE);range(argv[[1]],argv[[2]]);");
    }
    ...
    public void testrange11() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(4L, 5L, 1L, 5L, 3L, 4L, 5L, 3L, 2L, 4L), .Label = c(\'a\', \'c\', \'i\', \'s\', \'t\'), class = c(\'ordered\', \'factor\')), structure(c(4L, 2L, 3L, 5L, 4L, 3L, 5L, 1L, 5L, 4L), .Label = c(\'a\', \'c\', \'i\', \'s\', \'t\'), class = c(\'ordered\', \'factor\')), na.rm = FALSE);range(argv[[1]],argv[[2]],argv[[3]]);");
    }
    ...
    public void testrange20() {
        assertEval(Ignored.Unknown, "argv <- list(c(2.00256647265648e-308, 2.22284878464869e-308, 2.22507363599982e-308, 2.2250738585072e-308, 2.22507408101459e-308, 2.22729893236571e-308, 2.44758124435792e-308), na.rm = FALSE);range(argv[[1]],argv[[2]]);");
    }
    ...
    public void testrange26() {
        assertEval(Ignored.Unknown, "argv <- list(c(1.47191076131574, 0.586694550701453, 0.258706725324317, 0.948371836939988, 0.396080061109718, 0.350912037541581), finite = TRUE, na.rm = FALSE);range(argv[[1]],argv[[2]],argv[[3]]);");
    }
    ...
    public void testrange29() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1208822400, 1209168000, 1208822400, 1209168000), class = c(\'POSIXct\', \'POSIXt\'), tzone = \'GMT\'), na.rm = TRUE);range(argv[[1]],argv[[2]]);");
    }
