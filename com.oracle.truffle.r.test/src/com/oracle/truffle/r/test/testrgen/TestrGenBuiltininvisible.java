...
public class TestrGenBuiltininvisible extends TestBase {
    ...
    public void testinvisible13() {
        assertEval(Ignored.Unknown, "argv <- list(structure(function (...) new(\'test1\', ...), className = structure(\'test1\', package = \'.GlobalEnv\'), package = \'.GlobalEnv\', class = structure(\'classGeneratorFunction\', package = \'methods\')));invisible(argv[[1]]);");
    }
