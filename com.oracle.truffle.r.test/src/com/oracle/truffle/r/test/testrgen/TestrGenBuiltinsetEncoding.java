...
public class TestrGenBuiltinsetEncoding extends TestBase {

    @Test
    public void testsetEncoding1() {
        assertEval(Ignored.Unknown, "argv <- list(\'abc\', \'UTF-8\'); .Internal(setEncoding(argv[[1]], argv[[2]]))");
    }
