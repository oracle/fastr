...
// Checkstyle: stop line length check
                                                                 ...
                                                                 public class TestrGenBuiltinrownames extends TestBase {
	...
	public void testrownames2() {
		assertEval("argv <- structure(list(x = structure(logical(0), .Dim = c(4L,     0L)), do.NULL = FALSE), .Names = c(\'x\', \'do.NULL\'));"+
	...
	public void testrownames3() {
		assertEval("argv <- structure(list(x = structure(list(x = 3:4), .Names = \'x\',     row.names = c(NA, -2L), class = \'data.frame\')), .Names = \'x\');"+
			"do.call(\'rownames\', argv)");
	}
