...
public class TestrGenBuiltingrep extends TestBase {
    ...
    public void testgrep2() {
        assertEval(Ignored.Unknown, "argv <- list(\'éè\', \'«Latin-1 accented chars»: éè øØ å<Å æ<Æ é éè\', TRUE, FALSE, TRUE, FALSE, FALSE, FALSE); .Internal(grep(argv[[1]], argv[[2]], argv[[3]], argv[[4]], argv[[5]], argv[[6]], argv[[7]], argv[[8]]))");
    }
    ...
    public void testgrep7() {
        assertEval(Ignored.Unknown, "argv <- list(\''\', structure(\'exNSS4_1.0.tar.gz\', .Names = \'\'), FALSE, FALSE, FALSE, FALSE, FALSE, FALSE); .Internal(grep(argv[[1]], argv[[2]], argv[[3]], argv[[4]], argv[[5]], argv[[6]], argv[[7]], argv[[8]]))");
    }
