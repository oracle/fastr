...
public class TestrGenBuiltinabs extends TestBase {
    ...
    public void testabs7() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(3.5527136788005e-15+2.4168586625265e-16i, 2.4980018054066e-16-2.28189378671807e-16i, 0-6.89814774385614e-17i, 0-1.77454768520688e-17i), .Dim = c(2L, 2L)));abs(argv[[1]]);");
    }
    ...
    public void testabs12() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(1.47191076131574, 0.586694550701453, NA, 0.258706725324317, 0.948371836939988, 0.396080061109718, NA, 0.350912037541581), .Dim = c(4L, 2L), .Dimnames = list(c(\'(Intercept)\', \'x1\', \'x2\', \'x3\'), c(\'Estimate\', \'Std. Error\'))));abs(argv[[1]]);");
    }
    ...
    public void testabs18() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(8, 7, 6, 5, 4, 3, 2, 1, 0, -1), .Tsp = c(2, 11, 1), class = \'ts\'));abs(argv[[1]]);");
    }
    ...
    public void testabs21() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(2671, 6.026e+77, 3.161e+152, 3.501e+299, 2.409e+227, 1.529e+302), .Names = c(\'Min.\', \'1st Qu.\', \'Median\', \'Mean\', \'3rd Qu.\', \'Max.\')));abs(argv[[1]]);");
    }
}
