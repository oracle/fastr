...
public class TestrGenBuiltinstrptime extends TestBase {

    @Test
    public void teststrptime1() {
        assertEval(Ignored.Unknown, "argv <- list(\'2008-04-22 09:45\', \'%Y-%m-%d\', \'\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void teststrptime2() {
        assertEval(Ignored.Unknown, "argv <- list(character(0), \'%X\', \'\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void teststrptime3() {
        assertEval(Ignored.Unknown, "argv <- list(\'1970-01-01\', \'%Y-%m-%d %H:%M\', \'GMT\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void teststrptime4() {
        assertEval(Ignored.Unknown, "argv <- list(\'2007-11-06\', \'%Y-%m-%d\', \'GMT\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void teststrptime5() {
        assertEval(Ignored.Unknown, "argv <- list(\'1970-01-01\', \'%Y-%m-%d\', \'GMT\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void teststrptime6() {
        assertEval(Ignored.Unknown, "argv <- list(c(\'2007-11-06\', NA), \'%Y-%m-%d\', \'\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void teststrptime7() {
        assertEval(Ignored.Unknown, "argv <- list(c(\'20010101\', NA, NA, \'20041026\'), \'%Y%m%d\', \'GMT\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void teststrptime8() {
        assertEval(Ignored.Unknown, "argv <- list(\'2002-02-02 02:02\', \'%Y-%m-%d %H:%M\', \'\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }

    @Test
    public void teststrptime9() {
        assertEval(Ignored.Unknown, "argv <- list(c(\'1890/01/01\', \'1891/01/01\', \'1892/01/01\', \'1893/01/01\', \'1894/01/01\', \'1895/01/01\'), \'%Y/%m/%d\', \'\'); .Internal(strptime(argv[[1]], argv[[2]], argv[[3]]))");
    }
