...
public class TestrGenBuiltinattributes extends TestBase {
    ...
    public void testattributes5() {
        assertEval(Ignored.Unknown, "argv <- list(structure(c(\'o\', \'p\', \'v\', \'i\', \'r\', \'w\', \'b\', \'m\', \'f\', \'s\'), date = structure(1224086400, class = c(\'POSIXct\', \'POSIXt\'), tzone = \'\'), .S3Class = \'stamped\', class = structure(\'stamped\', package = \'.GlobalEnv\')));attributes(argv[[1]]);");
    }
