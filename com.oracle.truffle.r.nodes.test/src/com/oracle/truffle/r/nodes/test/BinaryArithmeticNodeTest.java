...
public class BinaryArithmeticNodeTest extends TestBase {
    ...
    @DataPoint public static final RAbstractVector NOT_COMPLETE_LOGICAL = createLogicalVector(new byte[]{1, 2, RRuntime.LOGICAL_NA, 4}, false);
