...
public class GetFunctions {
    ...
    public abstract static class MGet extends Adapter {
        ...
        private Object call(VirtualFrame frame, RFunction ifnFunc, String x) {
            ...
            Object[] callArgs = RArguments.create(RArguments.getContext(frame), ifnFunc, callCache.getSourceSection(), callerFrame, RArguments.getDepth(frame) + 1, new Object[]{x},
                            ArgumentsSignature.empty(1));
