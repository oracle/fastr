...
public class UtilsVariables implements RPackageVariables.Handler {
    ...
    private static final String[] C_NAMES = new String[] {
        "countfields", "readtablehead", "writetable", "menu", "typeconvert"
    };
    // @formatter: on

    public UtilsVariables() {
        RPackageVariables.registerHandler("utils", this);
    }

    @Override
    public void preInitialize(REnvironment utilsEnv) {
        REnvironment statsNamespaceEnv = ((REnvironment.Package) utilsEnv).getNamespace();
