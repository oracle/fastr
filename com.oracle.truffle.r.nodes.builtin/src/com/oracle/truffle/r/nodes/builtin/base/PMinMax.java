...
public abstract class PMinMax extends RBuiltinNode.Arg2 {
    ...
    public abstract static class PMax extends PMinMax {
        ...
        public PMax() {
            super(new ReduceSemantics(RRuntime.INT_MIN_VALUE, Double.NEGATIVE_INFINITY, false, RError.Message.NO_NONMISSING_MAX, RError.Message.NO_NONMISSING_MAX_NA, false, true, true),
    ...
    public abstract static class PMin extends PMinMax {
        ...
        public PMin() {
            super(new ReduceSemantics(RRuntime.INT_MAX_VALUE, Double.POSITIVE_INFINITY, false, RError.Message.NO_NONMISSING_MIN, RError.Message.NO_NONMISSING_MIN_NA, false, true, true),
    ...
    protected abstract static class MultiElemStringHandler extends RBaseNodeWithWarnings {
