...
import com.oracle.truffle.r.nodes.builtin.fastr.FastRFrameNames;
import com.oracle.truffle.r.nodes.builtin.fastr.FastRFrameNamesNodeGen;
...
public class BasePackage extends RBuiltinPackage {
    ...
    public BasePackage(RContext context) {
        ...
        add(FastRFrameNames.class, FastRFrameNamesNodeGen::create);
