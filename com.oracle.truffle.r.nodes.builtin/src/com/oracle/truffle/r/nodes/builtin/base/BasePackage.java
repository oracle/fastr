...
public class BasePackage extends RBuiltinPackage {
    ...
    public BasePackage() {
        ...
        add(BinaryLogic.NonVectorAndBuiltin.class, (arguments, builtin, signature) -> BinaryBooleanNonVectorizedNodeGen.create(BinaryLogic.NON_VECTOR_AND, arguments, builtin, signature));
        add(BinaryLogic.NonVectorOrBuiltin.class, (arguments, builtin, signature) -> BinaryBooleanNonVectorizedNodeGen.create(BinaryLogic.NON_VECTOR_OR, arguments, builtin, signature));
