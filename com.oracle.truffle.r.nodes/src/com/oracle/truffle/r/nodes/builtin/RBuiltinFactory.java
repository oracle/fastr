...
public final class RBuiltinFactory extends RBuiltinDescriptor {
    ...
    RBuiltinFactory(String name, Class<?> builtinMetaClass, Class<?> builtinNodeClass, RVisibility visibility, String[] aliases, RBuiltinKind kind, ArgumentsSignature signature, int[] nonEvalArgs,
                    boolean allowMissingInVarArgs, boolean splitCaller, boolean isFieldAccess, boolean lookupVarArgs,
        ...
        super(name, builtinMetaClass, builtinNodeClass, visibility, aliases, kind, signature, nonEvalArgs, allowMissingInVarArgs, splitCaller, isFieldAccess, lookupVarArgs, alwaysSplit, dispatch,
