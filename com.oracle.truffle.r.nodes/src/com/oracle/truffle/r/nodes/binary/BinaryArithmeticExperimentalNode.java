...
public abstract class BinaryArithmeticExperimentalNode extends BinaryNode {
    ...
    public BinaryArithmeticExperimentalNode(BinaryArithmeticFactory factory, UnaryArithmeticFactory unaryFactory) {
    ...
    public static BinaryArithmeticExperimentalNode create(BinaryArithmeticFactory arithmetic) {
        return BinaryArithmeticExperimentalNodeFactory.create(arithmetic, null, new RNode[2], null);
    }
