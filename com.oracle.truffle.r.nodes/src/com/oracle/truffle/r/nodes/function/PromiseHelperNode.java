 ...
 */
public class PromiseHelperNode extends NodeSA {

    public static class PromiseCheckHelperNode extends NodeSA {
    ...
    public static class PromiseDeoptimizeFrameNode extends NodeSA {
