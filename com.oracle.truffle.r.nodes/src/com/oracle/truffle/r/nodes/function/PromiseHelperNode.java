 ...
 */
public class PromiseHelperNode extends BaseRNode {

    public static class PromiseCheckHelperNode extends BaseRNode {
    ...
    public static class PromiseDeoptimizeFrameNode extends BaseRNode {
