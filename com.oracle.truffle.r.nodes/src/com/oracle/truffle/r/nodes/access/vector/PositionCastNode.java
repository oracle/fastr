...
abstract class PositionCastNode extends RBaseNode {
    ...
    @Specialization
    protected RAbstractVector doDouble(RDoubleVector position,
    ...
    protected RAbstractVector doLogical(byte position) {
        // directly supported
        return RDataFactory.createLogicalVectorFromScalar(position);
    }

    @Specialization
    protected RAbstractVector doLogical(RLogicalVector position) {
        // directly supported
        return position;
    }
