...
import com.oracle.truffle.r.library.stats.StatsFunctionsNodesFactory.Zeroin2NodeGen;
        ...
        protected RAbstractDoubleVector zeroin2(RFunction f, double xmin, double xmax, double fax, double fbx, double tol, int maxIter) {
            ...
            finished: while (true) {
                ...
                while (maxit-- > 0) { // Main iteration loop
                    double prevStep = b - a; /*
                                              * Distance from the last but one to the last
                                              * approximation
                                              */
                    double tolAct; /* Actual tolerance */
                    double p; /* Interpolation step is calcu- */
                    double q; /*
                               * lated in the form p/q; divi- sion operations is delayed until the
                               * last moment
                               */
                    ...
                    if (fabs(prevStep) >= tolAct /* If prev_step was large enough */
                        ...
                        if (p < (0.75 * cb * q - fabs(tolAct * q) / 2) /*
                            ...
                            newStep = p / q; /*
                                              * it is accepted If p/q is too large then the
                                              * bisection procedure can reduce [b,c] range to more
                                              * extent
                                              */
                        }
                    }
